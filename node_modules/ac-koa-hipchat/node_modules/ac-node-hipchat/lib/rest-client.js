...
RestClient.prototype.glancePushUser = function (resourceUrl, token, data) {
  return this._post(resourceUrl, token, null, 204, data);
};

RestClient.prototype.glancePushRoom = function (resourceUrl, token, data) {
  return this._post(resourceUrl, token, null, 204, data);
};

RestClient.prototype.glancePushGroup = function (resourceUrl, token, data) {
  return this._post(resourceUrl, token, null, 204, data);
};
